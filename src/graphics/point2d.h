...
class Point2D : public Vector3<double>
{
    /* =============================== PUBLIC =============================== */
...
public:
    ...
    double dotProduct( const Point2D &p ) const;

    std::ostream &out( std::ostream &os ) const override;

    static Matrix<Point2D*> matrixDeepCopy( const Matrix<Point2D*> &m );
    static void matrixDeepDelete( const Matrix<Point2D*> &m );
